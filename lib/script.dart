...
void main() {
  var myObj = {
    ...
    "home:widget.summaryCard.tooltip.assets": "Includes {{count}} new assets worth \${{change}}.",
    "home:widget.summaryCard.tooltip.liabilities": "Includes {{count}} new liabilities worth \${{change}}.",
    ...
    "common:emptyText.assetClassDescription": "Your asset class allocation will appear here once your data are added.",
    "common:emptyText.mapDescription": "The geographical allocation of your assets will appear here once your data are added.",
    ...
    "profile:localAuth.enableFaceId": "Enable login with face id \/ biometrics",
    "auth:login.toast.wrongToken": "Session expired. Please login again"
  };
