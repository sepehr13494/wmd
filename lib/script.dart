...
void main() {
  var myObj = {
    ...
    "auth:signup.text.aboutFamilyOffice": "About Petiole Asset Management AG",
    ...
    "auth:signup.checkbox.label": "I acknowledge that I read, understood and agree to Petiole Asset Management AG",
    ...
    "auth:signup.modal.aboutTfo.heading": "Who is Petiole Asset Management AG?",
    "auth:signup.modal.aboutTfo.text.first": "As a boutique asset manager, Petiole capitalizes on its expertise and international partners to build its clients robust diversified portfolios, in exclusive private market opportunities, capable of outperforming public markets.",
    ...
    "linkAccount:automaticLink.label.search": "Search for your bank name or select an option from the below list",
    ...
    "linkAccount:stepper.stepOne.action.active": "View form and signature letter",
    ...
    "assets:label.valuation": "Valuations",
    "assets:label.keepNetWorth": "Add your asset valuations to better track your net worth.",
    ...
    "home:custodianBankList.title": "The bank authorization process",
    ...
    "home:custodianBankList.statusText.signLetter": "The bank signed your letter of authorization",
    ...
    "home:assetNames.OtherAssets": "Other Assets",
    ...
    "assets:seeMore.labels.accountAdded": "Account added",
