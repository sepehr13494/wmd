...
class NetWorthResponseObj extends NetWorthEntity {
  ...
  factory NetWorthResponseObj.fromJson(Map<String, dynamic> json) =>
      NetWorthResponseObj(
        ...
        assets: Assets.fromJson(json["assets"]??const Assets(newAssetCount: 0, currentValue: 0,newAssetValue: 0, change: 0, changePercentage: 0, ytd: 0, itd: 0).toJson()),
        liabilities: Liabilities.fromJson(json["liabilities"]??const Liabilities(newLiabilityCount: 0, currentValue: 0,newLiabilityValue: 0, change: 0, ytd: 0, itd: 0).toJson()),
  ...
  static const NetWorthResponseObj tNetWorthResponseObj = NetWorthResponseObj(
      ...
      assets: Assets(newAssetCount: 0, currentValue: 0,newAssetValue: 0, change: 0,itd: 0,ytd: 0,changePercentage: 0),
      liabilities: Liabilities(newLiabilityCount: 0, currentValue: 0,newLiabilityValue: 0, change: 0,itd: 0,ytd: 0),
      durationInDays: 0,lastUpdated: "2022-12-31T00:00:00");
}
...
class Assets extends AssetsEntity {
  ...
  factory Assets.fromJson(Map<String, dynamic> json) => Assets(
    ...
    changePercentage: double.tryParse(json["changePercentage"].toString()) ?? 0,
...
class Liabilities extends LiabilitiesEntity {
  ...
  factory Liabilities.fromJson(Map<String, dynamic> json) => Liabilities(
        newLiabilityCount: double.tryParse(json["newLiabilityCount"].toString()) ?? 1,
        currentValue: double.tryParse(json["currentValue"].toString()) ?? 1,
    newLiabilityValue: double.tryParse(json["newLiabilityValue"].toString()) ?? 1,
