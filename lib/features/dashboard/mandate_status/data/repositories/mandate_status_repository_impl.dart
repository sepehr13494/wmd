...
class MandateStatusRepositoryImpl implements MandateStatusRepository {
  ...
  MandateStatusRepositoryImpl(this.remoteDataSource);
    ...
    @override
  Future<Either<Failure, List<GetMandateStatusEntity>>> getMandateStatus(GetMandateStatusParams params) async {
    try {
      ...
      @override
  Future<Either<Failure, AppSuccess>> deleteMandate(DeleteMandateParams params) async {
    try {
