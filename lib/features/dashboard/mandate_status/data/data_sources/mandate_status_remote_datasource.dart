...
abstract class MandateStatusRemoteDataSource {
  Future<List<GetMandateStatusResponse>> getMandateStatus(GetMandateStatusParams params);
...
class MandateStatusRemoteDataSourceImpl extends AppServerDataSource
  ...
  MandateStatusRemoteDataSourceImpl(super.errorHandlerMiddleware);
    ...
    @override
  Future<List<GetMandateStatusResponse>> getMandateStatus(GetMandateStatusParams params) async {
    try{
      final appRequestOptions =
          AppRequestOptions(RequestTypes.get, AppUrls.getMandateStatus, params.toJson());
      ...
      @override
  Future<DeleteMandateResponse> deleteMandate(DeleteMandateParams params) async {
    try{
      final appRequestOptions =
          AppRequestOptions(RequestTypes.get, AppUrls.deleteMandate, params.toJson());
      final response = await errorHandlerMiddleware.sendRequest(appRequestOptions);
