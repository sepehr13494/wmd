...
abstract class PerformanceTableRemoteDataSource {
  ...
  Future<List<GetCustodianPerformanceResponse>> getCustodianPerformance(GetCustodianPerformanceParams params);
...
class PerformanceTableRemoteDataSourceImpl extends AppServerDataSource
  ...
  PerformanceTableRemoteDataSourceImpl(super.errorHandlerMiddleware);
    ...
    @override
  Future<List<GetAssetClassResponse>> getAssetClass(GetAssetClassParams params) async {
    try{
      ...
      @override
  Future<List<GetBenchmarkResponse>> getBenchmark(GetBenchmarkParams params) async {
    try{
      final appRequestOptions =
          AppRequestOptions(RequestTypes.get, AppUrls.getBenchmark, params.toJson());
      final response = await errorHandlerMiddleware.sendRequest(appRequestOptions);
      ...
      @override
  Future<List<GetCustodianPerformanceResponse>> getCustodianPerformance(GetCustodianPerformanceParams params) async {
    try{
      final appRequestOptions =
          AppRequestOptions(RequestTypes.get, AppUrls.getCustodianPerformance, params.toJson());
      final response = await errorHandlerMiddleware.sendRequest(appRequestOptions);
      final result = (response as List<dynamic>)
