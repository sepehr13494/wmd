                  ...
                  },
                  {
                    ...
                    "onPress": () async {
                      final result = await GlobalFunctions.confirmProcess(
                        ...
                        yes: AppLocalizations.of(context).common_button_delete,
                        no: AppLocalizations.of(context).common_button_cancel,
                      );
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            SvgPicture.asset(
                              e["icon"],
                              height: e["icon"] == "assets/images/view-eye.svg"
                                  ? 24
                                  : 16,
                            ),
                            SizedBox(
                                width: e["icon"] == "assets/images/view-eye.svg"
                                    ? 10
                                    : 16),
                            Text(e["label"]),
                          ],
