                        ...
                        showDialog(
                          ...
                          builder: (context) {
                            return SuccessModalWidget(
                              title:
                                  'Loan is successfully added to wealth overview',
                              ...
                              children: [
                                ...
                                EachTextField(
                                  ...
                                  child: AppTextFields.simpleTextField(
                                      ...
                                      hint: "A nickname you give to your loan"),
                                ),
                                BlocSelector<BankListCubit, BankListState,
                                    List<String>>(
                                  selector: (state) => state is BankListSuccess
                                      ? state.banks.isEmpty
                                          ? ["No bank found"]
                                          : state.banks
                                              .map((e) => e.name)
                                ...
                                EachTextField(
                                  hasInfo: false,
                                  title: "Loan amount - sanctioned (optional)",
                                  child: AppTextFields.simpleTextField(
                                      required: false,
                                      type: TextFieldType.money,
                                      keyboardType: TextInputType.number,
