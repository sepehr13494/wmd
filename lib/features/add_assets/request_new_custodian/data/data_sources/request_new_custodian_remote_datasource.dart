...
abstract class RequestNewCustodianRemoteDataSource {
  Future<RequestNewCustodianResponse> requestNewCustodian(RequestNewCustodianParams params);
...
class RequestNewCustodianRemoteDataSourceImpl extends AppServerDataSource
  ...
  RequestNewCustodianRemoteDataSourceImpl(super.errorHandlerMiddleware);
    ...
    @override
  Future<RequestNewCustodianResponse> requestNewCustodian(RequestNewCustodianParams params) async {
    try{
      final appRequestOptions =
          AppRequestOptions(RequestTypes.get, AppUrls.requestNewCustodian, params.toJson());
