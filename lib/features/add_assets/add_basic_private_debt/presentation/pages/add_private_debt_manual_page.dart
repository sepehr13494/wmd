...
class AddPrivateDebtManualPage extends StatefulWidget {
  const AddPrivateDebtManualPage({Key? key}) : super(key: key);

  @override
  AppState<AddPrivateDebtManualPage> createState() =>
      _AddPrivateDebtManualPageState();
}

class _AddPrivateDebtManualPageState
    extends AppState<AddPrivateDebtManualPage> {
  ...
  @override
  void didUpdateWidget(covariant AddPrivateDebtManualPage oldWidget) {
