              ...
              children: [
                ...
                BlocConsumer<GlossaryCubit, GlossaryState>(
                  ...
                  builder: (context, state) {
                    return state is GetGlossariesLoaded
                        ? Builder(
                          builder: (context) {
                            bool isEmpty = true;
                            for (var element in state.getGlossariesEntities) {
                              if(element.record.isNotEmpty){
                                isEmpty = false;
                                continue;
                              }
                            }
                            return isEmpty ? const NoDataWidget() : ListView(
