...
abstract class EditListedAssetRemoteDataSource {
  ...
  Future<DeleteListedAssetResponse> deleteListedAsset(
      DeleteListedAssetParams params);
}
...
class EditListedAssetRemoteDataSourceImpl extends AppServerDataSource
  ...
  @override
  Future<PutListedAssetResponse> putListedAsset(
      PutListedAssetParams params) async {
    try {
      final appRequestOptions = AppRequestOptions(
          RequestTypes.put, AppUrls.putListedAsset, params.toServerJson());
      final response =
  ...
  @override
  Future<DeleteListedAssetResponse> deleteListedAsset(
      DeleteListedAssetParams params) async {
    try {
      final appRequestOptions = AppRequestOptions(
