...
class GetIsBlurredUseCase extends UseCase<GetIsBlurredEntity, GetIsBlurredParams> {
  final BlurredPrivacyRepository repository;

  GetIsBlurredUseCase(this.repository);
  
  @override
  Future<Either<Failure, GetIsBlurredEntity>> call(GetIsBlurredParams params) =>
