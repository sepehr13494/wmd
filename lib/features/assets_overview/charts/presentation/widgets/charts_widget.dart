      ...
      return BarChartGroupData(
        ...
        barRods: [
          BarChartRodData(
            toY: sum/x,
            rodStackItems: [
              BarChartRodStackItem(0, getChartEntity.bankAccount/x, AssetsOverviewChartsColors.colorsMap[AssetTypes.bankAccount]!),
              BarChartRodStackItem(getChartEntity.bankAccount/x, bankList, AssetsOverviewChartsColors.colorsMap[AssetTypes.listedAssetEquity]!),
              BarChartRodStackItem(bankList, bankListEquity, AssetsOverviewChartsColors.colorsMap[AssetTypes.privateEquity]!),
              BarChartRodStackItem(bankListEquity, bankListEquityDept, AssetsOverviewChartsColors.colorsMap[AssetTypes.privateDebt]!),
              BarChartRodStackItem(bankListEquityDept, bankListEquityDeptEstate, AssetsOverviewChartsColors.colorsMap[AssetTypes.realEstate]!),
              BarChartRodStackItem(bankListEquityDeptEstate, bankListEquityDeptEstateFix, AssetsOverviewChartsColors.colorsMap[AssetTypes.listedAssetFixedIncome]!),
              BarChartRodStackItem(bankListEquityDeptEstateFix, bankListEquityDeptEstateFixOther, AssetsOverviewChartsColors.colorsMap[AssetTypes.listedAssetOther]!),
              BarChartRodStackItem(bankListEquityDeptEstateFixOther, sum/x, AssetsOverviewChartsColors.colorsMap[AssetTypes.otherAsset]!),
            ],
