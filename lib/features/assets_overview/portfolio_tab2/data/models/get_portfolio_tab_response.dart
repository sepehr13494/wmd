...
class GetPortfolioTabResponse extends GetPortfolioTabEntity {
  ...
  factory GetPortfolioTabResponse.fromJson(Map<String, dynamic> json) =>
      GetPortfolioTabResponse(
        portfolioName: json["portfolioName"] ?? "",
        custodianBank: json["custodianBank"] ?? "",
        allocationPercentage:
            double.tryParse((json["allocationPercentage"] ?? 0).toString()) ??
                0,
        totalAmount:
            double.tryParse((json["totalAmount"] ?? 0).toString()) ?? 0,
  ...
  static final tResponse = [
    GetPortfolioTabResponse.fromJson({
