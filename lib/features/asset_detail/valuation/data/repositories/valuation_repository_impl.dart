...
class ValuationRepositoryImpl implements ValuationRepository {
  ...
  ValuationRepositoryImpl(this.remoteDataSource);
    ...
    @override
  Future<Either<Failure, List<GetAllValuationEntity>>> getAllValuation(GetAllValuationParams params) async {
    try {
      ...
      @override
  Future<Either<Failure, AppSuccess>> postValuation(PostValuationParams params) async {
    try {
      ...
      @override
  Future<Either<Failure, List<GetValuationPerformanceEntity>>> getValuationPerformance(GetValuationPerformanceParams params) async {
    try {
