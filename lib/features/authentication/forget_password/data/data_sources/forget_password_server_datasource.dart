...
class ForgetPasswordServerDataSourceImpl extends AppServerDataSource
    implements ForgetPasswordServerDataSource {
  ...
  Future<void> forgetPassword(ForgetPasswordParams forgetPasswordParams) async {
    ...
    final response = await errorHandlerMiddleware
        .sendRequest(forgetPasswordAppRequestOptions);
    return;
  }

  @override
  Future<void> resetPassword(ResetPasswordParams resetPasswordParams) async {
    final resetPasswordAppRequestOptions = AppRequestOptions(
      RequestTypes.post,
      AppUrls.resetPassword,
      resetPasswordParams.toJson(),
    );
    final response = await errorHandlerMiddleware
        .sendRequest(resetPasswordAppRequestOptions);
    return;
  }
}
