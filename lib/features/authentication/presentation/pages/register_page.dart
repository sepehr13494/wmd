           ...
           child: FormBuilder(
             ...
             child: Column(
               children: [
                 ...
                 Text(appLocalizations.create_account,style: textTheme.headlineSmall),
                 ...
                 AppTextFields.simpleTextField(name: "password",hint: appLocalizations.sign_up_password_placeholder),
                 FormBuilderCheckbox(name: "terms", title:  RichText(text: TextSpan(
                     style: const TextStyle(height: 1.3),
                     children: [
                       TextSpan(text: "${appLocalizations.sign_up_terms_conditions} ",style: textTheme.bodySmall),
                       TextSpan(text: appLocalizations.sign_up_policy,style: textTheme.bodySmall!.toLinkStyle(context)),
                     ]
                 ))),
