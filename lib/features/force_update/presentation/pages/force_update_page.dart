             ...
             SizedBox(width: 120,child: ElevatedButton(onPressed: (){
               if(!kIsWeb){
                 if(Platform.isAndroid){
                   AppUrlLauncher.appLaunchUrl("https://play.google.com/store/apps/details?id=com.tfo.aio");
                 }else if(Platform.isIOS){
                   AppUrlLauncher.appLaunchUrl("https://apps.apple.com/us/app/all-in-one/id1672920609");
                 }
               }
