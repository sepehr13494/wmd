...
class AppFormBuilderDateTimePicker extends FormBuilderField<DateTime> {
  ...
  AppFormBuilderDateTimePicker({
    ...
    builder: (FormFieldState<DateTime?> field) {
      ...
      return TextField(
        ...
        minLines: minLines,
        expands: expands,
        style: TextStyle(color : state.enabled ? null : Theme.of(state.context).disabledColor),
  ...
  @override
  FormBuilderFieldState<AppFormBuilderDateTimePicker, DateTime> createState() =>
      _FormBuilderDateTimePickerState();
}

class _FormBuilderDateTimePickerState
    extends FormBuilderFieldState<AppFormBuilderDateTimePicker, DateTime> {
