...
class AppRouter extends _i5.RootStackRouter {
  ...
  final Map<String, _i5.PageFactory> pagesMap = {
    ...
    MainRoute.name: (routeData) {
      ...
      return _i5.MaterialPageX<dynamic>(
          routeData: routeData,
          child: _i4.MainPage(key: args.key, title: args.title));
    }
  };
...
class MainRoute extends _i5.PageRouteInfo<MainRouteArgs> {
  MainRoute({_i6.Key? key, String title = "title"})
      : super(MainRoute.name,
            path: '/main-page', args: MainRouteArgs(key: key, title: title));

  static const String name = 'MainRoute';
}

class MainRouteArgs {
  const MainRouteArgs({this.key, this.title = "title"});
