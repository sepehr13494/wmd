...
class AppUrls {
  ...
  static String putLoanLiability = "${wealthBase}loans";
  static String deleteLoanLiability = "${wealthBase}loans";
  ...
  //transaction
  static String getAllTransaction = "${wealthBase}Transaction/all";
  ...
  static String getUserMandates = "${userBase}User/mandates";
