...
// in wmd/test/features/add_assets/add_private_equity/data/repositories/private_equity_repository_impl_test.dart.
...
/// A class which mocks [PrivateEquityRemoteDataSource].
///
/// See the documentation for Mockito's code generation for more information.
class MockPrivateEquityRemoteDataSource extends _i1.Mock
    implements _i3.PrivateEquityRemoteDataSource {
  MockPrivateEquityRemoteDataSource() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<_i2.AddAssetModel> postPrivateEquityDetails(
          _i5.AddPrivateEquityParams? addPrivateEquityParams) =>
      (super.noSuchMethod(
        Invocation.method(
          #postPrivateEquityDetails,
